  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col">
        <span className="text-[#C9A84C] text-[10px] tracking-[0.25em] uppercase font-medium block mb-5">
          {String(index + 1).padStart(2, "0")}
        </span>
        <h3 className="text-white font-semibold tracking-tight text-base leading-snug mb-3 pr-[15%]">
          {title}
        </h3>
      ...
      <div className="flex items-center gap-2 mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-75">
        <span className="text-[#C9A84C] text-[10px] tracking-[0.2em] uppercase">
          {learnMore}
        </span>
