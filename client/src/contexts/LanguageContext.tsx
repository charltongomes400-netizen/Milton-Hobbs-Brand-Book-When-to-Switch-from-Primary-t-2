...
const translations = {
  EN: {
    ...
    footer: {
      ...
      parisLabel: "Paris, France",
      parisAddr: ["11, Boulevard Sébastopol", "75001 Paris", "France", "+33 1 80 27 00 67"],
  ...
  FR: {
    ...
    contact: {
      ...
      headline: "Parlons de votre dossier.",
      subtext:
        "Que vous ayez besoin d'un conseil immédiat ou que vous planifiiez à l'avance, nos associés sont prêts à vous assister depuis nos bureaux de Dubaï et Paris.",
      ...
      messagePlaceholder: "Décrivez votre dossier...",
      submit: "Envoyer le Message",
      submitting: "Envoi en cours...",
      successTitle: "Message envoyé",
      successText: "Merci. Un membre de notre équipe vous contactera très prochainement.",
      officeLabel: "Nos Bureaux",
      dubaiLabel: "Dubaï, EAU",
      parisLabel: "Paris, France",
    },
    footer: {
      tagline:
