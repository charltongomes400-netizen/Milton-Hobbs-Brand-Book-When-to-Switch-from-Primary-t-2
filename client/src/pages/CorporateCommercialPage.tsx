...
const PAGE_TEXT = {
  EN: {
    ...
    heroH1: "Corporate & Commercial",
    heroSub: "Structuring transactions. Governing commerce. Building lasting legal foundations.",
    ...
    stat3Val: "Direct access",  stat3Label: "Partner-led mandates",
    scroll: "Scroll",
  ...
  FR: {
    ...
    heroH1: "Droit des Sociétés et Commercial",
    heroSub: "Structurer les transactions. Régir le commerce. Bâtir des fondations juridiques durables.",
    ...
    stat3Val: "Accès direct",   stat3Label: "Mandats pilotés par les associés",
    scroll: "Défiler",
    ...
    overviewP2: "Le modèle boutique du cabinet garantit un accès direct aux associés sur chaque mandat, avec une attention rigoureuse à la réalité commerciale et à la précision juridique. Notre clientèle comprend des PME régionales, des multinationales s'implantant dans le CCG, des startups en levée de fonds et des investisseurs structurant des opérations Golfe–Europe.",
...
const SERVICES_EN = [
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-full h-full">
        ...
        <line x1="12" y1="19" x2="28" y2="19" stroke="rgba(255,255,255,0.35)" strokeWidth="1" />
        <line x1="12" y1="24" x2="22" y2="24" stroke="rgba(255,255,255,0.2)" strokeWidth="1" />
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-full h-full">
        ...
        <path d="M20 13v14" stroke="rgba(255,255,255,0.2)" strokeWidth="1" />
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-full h-full">
        ...
        <line x1="13" y1="14" x2="27" y2="14" stroke="rgba(255,255,255,0.3)" strokeWidth="1" />
        <line x1="13" y1="19" x2="27" y2="19" stroke="rgba(255,255,255,0.3)" strokeWidth="1" />
        <line x1="13" y1="24" x2="22" y2="24" stroke="rgba(255,255,255,0.2)" strokeWidth="1" />
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-full h-full">
        ...
        <line x1="20" y1="14" x2="20" y2="20" stroke="rgba(255,255,255,0.25)" strokeWidth="1" />
        <line x1="20" y1="20" x2="11" y2="26" stroke="rgba(255,255,255,0.2)" strokeWidth="1" />
        <line x1="20" y1="20" x2="29" y2="26" stroke="rgba(255,255,255,0.2)" strokeWidth="1" />
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" fill="none" className="w-full h-full">
        ...
        <ellipse cx="20" cy="20" rx="6" ry="13" stroke="rgba(255,255,255,0.25)" strokeWidth="1" />
        <line x1="7" y1="20" x2="33" y2="20" stroke="rgba(255,255,255,0.25)" strokeWidth="1" />
        <line x1="9" y1="14" x2="31" y2="14" stroke="rgba(255,255,255,0.15)" strokeWidth="0.7" />
        <line x1="9" y1="26" x2="31" y2="26" stroke="rgba(255,255,255,0.15)" strokeWidth="0.7" />
...
/* ─── INNER PAGE (uses LanguageContext) ─────────────────────────────────────── */
    ...
    <div className="bg-[#001489] min-h-screen">
      ...
      >
        <div
          ...
          style={{ backgroundImage: "radial-gradient(rgba(255,255,255,0.055) 1px, transparent 1px)", backgroundSize: "38px 38px" }}
        />
        ...
        {ACCENT_TILES.map((tile, i) => (
          <motion.div
            ...
            style={{ left: tile.left, top: tile.top, width: TILE_SZ, height: TILE_SZ, backgroundColor: tile.col }}
            animate={{ opacity: [0, 0, 0.6, 0.6, 0, 0] }}
            transition={{ duration: tile.dur, delay: tile.delay, repeat: Infinity, ease: "easeInOut", times: [0, 0.15, 0.30, 0.70, 0.85, 1] }}
          />
        ))}

        <div className="absolute bottom-0 left-0 right-0 h-48 pointer-events-none" style={{ background: "linear-gradient(to bottom, transparent, rgba(0,10,79,0.45))" }} />
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-8 py-20 w-full">
          <div className="max-w-[780px]">
            ...
            >
              <a href="/#expertise" className="flex items-center gap-2 text-[#D4AF36] text-[10px] tracking-[0.3em] uppercase font-semibold hover:opacity-70 transition-opacity">
            ...
            <motion.p
              ...
              className="text-[#D4AF36] text-[11px] tracking-[0.35em] uppercase font-bold mb-5"
            >
              {tx.heroEyebrow}
            </motion.p>
      ...
      >
        <div className="max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-[1fr_400px] gap-20 items-start">
            ...
            >
              <p className="text-[#D4AF36] text-[11px] tracking-[0.35em] uppercase font-bold mb-5">{tx.overviewEyebrow}</p>
      ...
      >
        <div className="max-w-[1400px] mx-auto">
          <motion.div
            ...
            className="mb-14"
          >
            <p className="text-[#D4AF36] text-[11px] tracking-[0.35em] uppercase font-bold mb-4">{tx.servicesEyebrow}</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-[#001489]/60">
            {services.map((svc, i) => (
              <motion.div
                key={i}
                ...
                className="group bg-[#000A4F] p-8 flex flex-col hover:bg-[#001489] transition-colors duration-300 cursor-default"
              >
                <div className="w-10 h-10 mb-6 opacity-90 group-hover:opacity-100 transition-opacity">{svc.icon}</div>
                <p className="text-[#D4AF36] text-[9px] tracking-[0.28em] uppercase font-bold mb-3">{svc.num}</p>
                <h3 className="font-heading text-white font-bold text-lg leading-snug mb-4">{svc.title}</h3>
                <div className="h-px w-8 bg-[#D4AF36]/40 mb-4 group-hover:bg-[#D4AF36]/70 transition-colors" />
                <p className="text-white/50 text-sm leading-relaxed flex-1 group-hover:text-white/70 transition-colors">{svc.description}</p>
                <div className="mt-6 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <a href="/#contact" className="text-[#D4AF36] text-[10px] tracking-[0.2em] uppercase font-semibold inline-flex items-center gap-2 hover:gap-3 transition-all">
                    {tx.hoverCta}
                    <svg className="w-3 h-3" fill="none" viewBox="0 0 12 12"><path d="M1 6h10M6 1l5 5-5 5" stroke="currentColor" strokeWidth="1.3" /></svg>
                  </a>
                </div>
      ...
      >
        <div className="max-w-[1400px] mx-auto">
          <motion.div
            ...
            className="mb-14"
          >
            <p className="text-[#D4AF36] text-[11px] tracking-[0.35em] uppercase font-bold mb-4">{tx.whyEyebrow}</p>
            ...
            {differentiators.map((d, i) => (
              ...
              >
                <div className="w-8 h-8 border border-[#D4AF36]/40 flex items-center justify-center mb-6 flex-shrink-0">
                  <span className="font-heading text-[#D4AF36] font-bold text-sm">{String(i + 1).padStart(2, "0")}</span>
                </div>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
            <motion.div
              ...
              transition={{ duration: 0.65 }}
            >
              <p className="text-[#D4AF36] text-[11px] tracking-[0.35em] uppercase font-bold mb-4">{tx.bannerEyebrow}</p>
