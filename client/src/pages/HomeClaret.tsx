...
function Hero() {
  ...
  return (
    <section
      ...
      className="relative min-h-screen flex items-center overflow-hidden" style={{ backgroundColor: "#3B0A1E" }}
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-8 pt-36 pb-24 w-full">
        ...
        >
          <motion.p
            ...
            className="text-[#C9A84C] text-xs tracking-[0.3em] uppercase font-semibold mb-8"
          ...
          <motion.div
            ...
            className="h-[2px] mb-8" style={{ backgroundColor: "#C9A84C" }}
          />
  ...
  return (
    <a
      ...
      className={`relative group inline-flex items-center px-8 py-[14px] text-xs font-semibold tracking-[0.18em] uppercase transition-colors duration-300 ${
        variant === "solid"
          ? "bg-white text-[#3B0A1E] hover:bg-[#C9A84C] hover:text-white"
    ...
    <svg viewBox="0 0 320 260" fill="none" className="w-full h-full">
      ...
      {Array.from({ length: spokes }).map((_, i) => {
        ...
        return (
          <motion.circle
            key={i} cx={x} cy={y} r={3}
            fill="#B07890" fillOpacity={0.5}
            animate={{ fillOpacity: [0.2, 0.7, 0.2] }}
            transition={{ duration: 2.5, delay: i * 0.3, repeat: Infinity, ease: "easeInOut" }}
          />
        );
      })}
      <circle cx={cx} cy={cy} r={outerR} stroke="#B07890" strokeOpacity={0.1} strokeWidth={1} fill="none" />
      <circle cx={cx} cy={cy} r={innerR} stroke="#C9A84C" strokeOpacity={0.4} strokeWidth={1} fill="none" />
      <circle cx={cx} cy={cy} r={8} fill="#C9A84C" fillOpacity={0.95} />
      <motion.circle
...
function PrecisionVisual() {
  ...
  return (
    <svg viewBox="0 0 320 260" fill="none" className="w-full h-full">
      ...
      <line x1={CX} y1={30} x2={CX} y2={230} stroke="#B07890" strokeOpacity={0.12} strokeWidth={1} />
      <line x1={40} y1={CY} x2={280} y2={CY} stroke="#B07890" strokeOpacity={0.12} strokeWidth={1} />

      <circle cx={CX} cy={CY} r={4}
        fill={locked ? "#C9A84C" : "#B07890"}
      ...
      <motion.g style={{ x: rx, y: ry }}>
        <circle cx={CX} cy={CY} r={22}
          stroke="#C9A84C" strokeWidth={1.5} fill="none" strokeOpacity={0.9}
        />
        <path d={`M${CX - 22} ${CY - 9} L${CX - 22} ${CY - 22} L${CX - 9} ${CY - 22}`} stroke="#C9A84C" strokeWidth={1.5} fill="none" />
        <path d={`M${CX + 9} ${CY - 22} L${CX + 22} ${CY - 22} L${CX + 22} ${CY - 9}`} stroke="#C9A84C" strokeWidth={1.5} fill="none" />
        <path d={`M${CX + 22} ${CY + 9} L${CX + 22} ${CY + 22} L${CX + 9} ${CY + 22}`} stroke="#C9A84C" strokeWidth={1.5} fill="none" />
        <path d={`M${CX - 9} ${CY + 22} L${CX - 22} ${CY + 22} L${CX - 22} ${CY + 9}`} stroke="#C9A84C" strokeWidth={1.5} fill="none" />
        <line x1={CX - 9} y1={CY} x2={CX + 9} y2={CY} stroke="#C9A84C" strokeWidth={1} strokeOpacity={0.7} />
        <line x1={CX} y1={CY - 9} x2={CX} y2={CY + 9} stroke="#C9A84C" strokeWidth={1} strokeOpacity={0.7} />
      </motion.g>

      {locked && (
        <motion.text
          x={CX + 30} y={CY - 28}
          fill="#C9A84C" fontSize="8" fontFamily="monospace" letterSpacing="0.15em"
...
function CrossBorderVisual() {
  ...
  return (
    <svg viewBox="0 0 320 260" fill="none" className="w-full h-full">
      ...
      {nodes.map((n, i) => (
        <g key={i}>
          <circle cx={n.cx} cy={n.cy} r={5} fill="#B07890" fillOpacity={0.65} />
          <text x={n.cx} y={n.cy + (i < 2 ? -12 : 18)}
            fill="#B07890" fillOpacity={0.45} fontSize="8"
            fontFamily="sans-serif" textAnchor="middle"
          >{n.label}</text>
        </g>
      ))}
      <circle cx={160} cy={130} r={7} fill="#C9A84C" fillOpacity={0.95} />
      <motion.circle
        cx={160} cy={130} r={18}
        stroke="#C9A84C" strokeWidth={1} fill="none"
  ...
  return (
    <svg viewBox="0 0 320 260" fill="none" className="w-full h-full">
      {rings.map((r, i) => {
        ...
        return (
          <motion.circle
            ...
            stroke={i === rings.length - 1 ? "#C9A84C" : "#B07890"}
      ...
      <motion.rect
        ...
        stroke="#C9A84C" strokeWidth={1.2} fill="none" strokeOpacity={0.85}
...
function Differentiators() {
  ...
  return (
    <section
      ...
      className="py-28 px-8" style={{ backgroundColor: "#3B0A1E" }}
    >
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <p className="text-[#C9A84C] text-xs tracking-[0.3em] uppercase font-medium mb-10">
              {d.eyebrow}
            </p>
            ...
            <div className="flex flex-col">
              {d.cards.map((card, i) => (
                ...
                >
                  <motion.span
                    className="w-0.5 flex-shrink-0 origin-top" style={{ backgroundColor: "#C9A84C" }}
          ...
          <div
            ...
            onMouseLeave={() => setPaused(false)}
          >
            <div className="relative w-full overflow-hidden" style={{ backgroundColor: "#18030B", aspectRatio: "4/3" }}>
              ...
              <div className="absolute bottom-0 left-0 right-0 h-px bg-white/10">
                <motion.div
                  className="h-full" style={{ backgroundColor: "#C9A84C" }}
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <a
                  href="#contact"
                  className="inline-flex items-center gap-3 bg-[#C9A84C] text-[#3B0A1E] text-xs tracking-[0.18em] uppercase font-bold px-7 py-4 hover:bg-[#B8943E] transition-colors"
                >
...
function PracticeCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#120209]/95 via-[#2A0615]/55 to-[#3B0A1E]/20" />

      <BorderTrace />

      <span className="absolute top-6 left-7 text-[#C9A84C] text-[10px] tracking-[0.25em] uppercase font-medium">
...
function PracticeAreas() {
  ...
  return (
    <section
      ...
      className="py-28 px-8" style={{ backgroundColor: "#2A0615" }}
    >
      <div className="max-w-[1400px] mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
...
function BorderTrace() {
  return (
    <span className="pointer-events-none absolute inset-0 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
      <span className="absolute top-0 left-0 right-0 h-px origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500" style={{ backgroundColor: "#C9A84C" }} />
      <span className="absolute top-0 right-0 bottom-0 w-px origin-top scale-y-0 group-hover:scale-y-100 transition-transform duration-500 delay-100" style={{ backgroundColor: "#C9A84C" }} />
      <span className="absolute bottom-0 left-0 right-0 h-px origin-right scale-x-0 group-hover:scale-x-100 transition-transform duration-500 delay-200" style={{ backgroundColor: "#C9A84C" }} />
      <span className="absolute top-0 left-0 bottom-0 w-px origin-bottom scale-y-0 group-hover:scale-y-100 transition-transform duration-500 delay-300" style={{ backgroundColor: "#C9A84C" }} />
    </span>
  );
}
...
function ArticleCard({
  ...
  return (
    <motion.a
      ...
      className="group flex flex-col rounded-sm overflow-hidden border border-[#F5E5EC] bg-white hover:shadow-lg transition-shadow duration-300 cursor-pointer"
    >
      <div className="relative h-44 flex-shrink-0 overflow-hidden" style={{ backgroundColor: "#FDF0F4" }}>
        {img ? (
          <img
            src={img}
            alt={article.title}
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#3B0A1E]/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      </div>
      ...
      <div className="flex flex-col flex-1 p-6 gap-3">
        ...
        <h3 className="font-heading text-[#3B0A1E] text-[0.95rem] font-bold leading-snug tracking-tight group-hover:text-[#7A1A40] transition-colors">
          {article.title}
        </h3>
        ...
        <div className="flex items-center justify-between pt-3 border-t border-[#F0F4FB] mt-auto">
          ...
          <div className="flex items-center gap-1.5 text-[#3B0A1E] group-hover:text-[#C9A84C] transition-colors">
  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          <div>
            <p className="text-[#B07890] text-[10px] tracking-[0.3em] uppercase font-semibold mb-3">
              {ins.eyebrow}
            </p>
            <h2 className="font-heading text-[#3B0A1E] text-[clamp(1.6rem,2.8vw,2.5rem)] font-bold tracking-tight">
              {ins.headline}
            </h2>
          </div>
          <a
            ...
            className="group flex items-center gap-2 text-[#3B0A1E] hover:text-[#C9A84C] text-xs tracking-[0.15em] uppercase font-medium transition-colors whitespace-nowrap"
          >
    ...
    >
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          ...
          <h2 className="font-heading text-[#3B0A1E] text-[clamp(1.8rem,3vw,2.8rem)] font-semibold tracking-tight">
            {c.headline}
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-16 lg:gap-24">
          ...
          >
            <p className="text-[#3B0A1E]/60 text-sm leading-relaxed">{c.subtext}</p>

            <div>
              <p className="text-[#C9A84C] text-[10px] tracking-[0.25em] uppercase font-medium mb-5">
                {c.officeLabel}
              </p>
              <div className="flex flex-col gap-6">
                <div>
                  <p className="text-[#3B0A1E] text-sm font-semibold mb-1">{c.dubaiLabel}</p>
                  {f.dubaiAddr.map((line, i) => (
                    <p key={i} className="text-[#3B0A1E]/50 text-xs leading-relaxed">{line}</p>
                  ))}
                </div>
                <div>
                  <p className="text-[#3B0A1E] text-sm font-semibold mb-1">{c.parisLabel}</p>
            ...
            <div className="flex flex-col gap-2">
              <a
                ...
                className="text-[#3B0A1E]/60 hover:text-[#C9A84C] text-sm transition-colors"
              >
                {f.email}
              </a>
              <a
          ...
          >
            {submitted ? (
              <div
                ...
                className="border border-[#C9A84C]/40 p-10 flex flex-col gap-4 h-full justify-center"
              >
                <div className="flex items-center gap-3 mb-2">
                  <svg className="w-5 h-5 text-[#C9A84C]" fill="none" viewBox="0 0 20 20">
                    <path d="M4 10l4 4 8-8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  <h3 className="font-heading text-[#3B0A1E] text-lg font-semibold">{c.successTitle}</h3>
                </div>
                <p className="text-[#3B0A1E]/60 text-sm leading-relaxed">{c.successText}</p>
              </div>
            ) : (
              <form
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input
                    ...
                    className="/[0.03] border border-[#3B0A1E]/15 text-[#3B0A1E] placeholder-[#3B0A1E]/30 text-sm px-4 py-3.5 outline-none focus:border-[#C9A84C]/60 transition-colors" style={{ backgroundColor: "#3B0A1E" }}
                  />
                  <input
                    type="email"
                    name="email"
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full /[0.03] border border-[#3B0A1E]/15 text-sm px-4 py-3.5 outline-none focus:border-[#C9A84C]/60 transition-colors appearance-none cursor-pointer" style={{ backgroundColor: "#3B0A1E" }}
                    style={{ color: form.subject ? "#3B0A1E" : "rgba(0,20,137,0.3)" }}
                  >
                    <option value="" disabled hidden>{c.subjectPlaceholder}</option>
                    {c.subjectOptions.map((opt, i) => (
                      <option key={i} value={opt} style={{ color: "#3B0A1E", background: "#fff" }}>
                        {opt}
                      </option>
                    ))}
                  </select>
                  <svg
                    className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 w-3 h-3 text-[#3B0A1E]/30"
                    fill="none"
                    viewBox="0 0 12 12"
                  >
                ...
                <textarea
                  ...
                  className="/[0.03] border border-[#3B0A1E]/15 text-[#3B0A1E] placeholder-[#3B0A1E]/30 text-sm px-4 py-3.5 outline-none focus:border-[#C9A84C]/60 transition-colors resize-none" style={{ backgroundColor: "#3B0A1E" }}
                />
                ...
                <button
                  ...
                  className="self-start bg-[#C9A84C] text-[#3B0A1E] text-xs tracking-[0.2em] uppercase font-semibold px-8 py-4 hover:bg-[#B8943E] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                >
...
function Footer() {
  ...
  return (
    <footer id="contact" data-testid="footer" className="border-t border-white/8" style={{ backgroundColor: "#18030B" }}>
          ...
          <div className="lg:col-span-5 lg:pr-16">
            ...
            <div className="space-y-2">
              <a
                ...
                className="block text-[#C9A84C] text-sm hover:text-[#DCC070] transition-colors"
              >
                {f.email}
              </a>
...
function ClaretInner() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#3B0A1E" }} data-testid="home-v7-page">
      <Header />
      <main>
        <Hero />
        <Insights />
...
export default function Claret() {
  return (
    <LanguageProvider>
      <ClaretInner />
    </LanguageProvider>
