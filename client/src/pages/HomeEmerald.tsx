      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-8 pt-36 pb-24 w-full">
        ...
        >
          <motion.p
            ...
            className="text-[#C8A84B] text-xs tracking-[0.3em] uppercase font-semibold mb-8"
  ...
  return (
    <a
      ...
      className={`relative group inline-flex items-center px-8 py-[14px] text-xs font-semibold tracking-[0.18em] uppercase transition-colors duration-300 ${
        variant === "solid"
          ? "bg-white text-[#0A3020] hover:bg-[#C8A84B] hover:text-white"
    ...
    <svg viewBox="0 0 320 260" fill="none" className="w-full h-full">
      ...
      {Array.from({ length: spokes }).map((_, i) => {
        ...
        return (
          <motion.circle
            key={i} cx={x} cy={y} r={3}
            fill="#5AAA82" fillOpacity={0.5}
            animate={{ fillOpacity: [0.2, 0.7, 0.2] }}
            transition={{ duration: 2.5, delay: i * 0.3, repeat: Infinity, ease: "easeInOut" }}
          />
        );
      })}
      <circle cx={cx} cy={cy} r={outerR} stroke="#5AAA82" strokeOpacity={0.1} strokeWidth={1} fill="none" />
      <circle cx={cx} cy={cy} r={innerR} stroke="#C8A84B" strokeOpacity={0.4} strokeWidth={1} fill="none" />
      <circle cx={cx} cy={cy} r={8} fill="#C8A84B" fillOpacity={0.95} />
      <motion.circle
...
function PrecisionVisual() {
  ...
  return (
    <svg viewBox="0 0 320 260" fill="none" className="w-full h-full">
      ...
      <line x1={CX} y1={30} x2={CX} y2={230} stroke="#5AAA82" strokeOpacity={0.12} strokeWidth={1} />
      <line x1={40} y1={CY} x2={280} y2={CY} stroke="#5AAA82" strokeOpacity={0.12} strokeWidth={1} />

      <circle cx={CX} cy={CY} r={4}
        fill={locked ? "#C8A84B" : "#5AAA82"}
      ...
      {locked && (
        <AnimatePresence>
          <motion.circle
            key={flashKey}
            cx={CX} cy={CY} r={22}
            stroke="#C8A84B" strokeWidth={2} fill="none"
      ...
      <motion.g style={{ x: rx, y: ry }}>
        <circle cx={CX} cy={CY} r={22}
          stroke="#C8A84B" strokeWidth={1.5} fill="none" strokeOpacity={0.9}
        />
        <path d={`M${CX - 22} ${CY - 9} L${CX - 22} ${CY - 22} L${CX - 9} ${CY - 22}`} stroke="#C8A84B" strokeWidth={1.5} fill="none" />
        <path d={`M${CX + 9} ${CY - 22} L${CX + 22} ${CY - 22} L${CX + 22} ${CY - 9}`} stroke="#C8A84B" strokeWidth={1.5} fill="none" />
        <path d={`M${CX + 22} ${CY + 9} L${CX + 22} ${CY + 22} L${CX + 9} ${CY + 22}`} stroke="#C8A84B" strokeWidth={1.5} fill="none" />
        <path d={`M${CX - 9} ${CY + 22} L${CX - 22} ${CY + 22} L${CX - 22} ${CY + 9}`} stroke="#C8A84B" strokeWidth={1.5} fill="none" />
        <line x1={CX - 9} y1={CY} x2={CX + 9} y2={CY} stroke="#C8A84B" strokeWidth={1} strokeOpacity={0.7} />
        <line x1={CX} y1={CY - 9} x2={CX} y2={CY + 9} stroke="#C8A84B" strokeWidth={1} strokeOpacity={0.7} />
      </motion.g>

      {locked && (
        <motion.text
          x={CX + 30} y={CY - 28}
          fill="#C8A84B" fontSize="8" fontFamily="monospace" letterSpacing="0.15em"
...
function CrossBorderVisual() {
  ...
  return (
    <svg viewBox="0 0 320 260" fill="none" className="w-full h-full">
      ...
      {nodes.map((n, i) => (
        <g key={i}>
          <circle cx={n.cx} cy={n.cy} r={5} fill="#5AAA82" fillOpacity={0.65} />
          <text x={n.cx} y={n.cy + (i < 2 ? -12 : 18)}
            fill="#5AAA82" fillOpacity={0.45} fontSize="8"
            fontFamily="sans-serif" textAnchor="middle"
          >{n.label}</text>
        </g>
      ))}
      <circle cx={160} cy={130} r={7} fill="#C8A84B" fillOpacity={0.95} />
      <motion.circle
        cx={160} cy={130} r={18}
        stroke="#C8A84B" strokeWidth={1} fill="none"
  ...
  return (
    <svg viewBox="0 0 320 260" fill="none" className="w-full h-full">
      {rings.map((r, i) => {
        ...
        return (
          <motion.circle
            ...
            stroke={i === rings.length - 1 ? "#C8A84B" : "#5AAA82"}
      ...
      <motion.rect
        ...
        stroke="#C8A84B" strokeWidth={1.2} fill="none" strokeOpacity={0.85}
    ...
    >
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <p className="text-[#C8A84B] text-xs tracking-[0.3em] uppercase font-medium mb-10">
              {d.eyebrow}
            </p>
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <a
                  href="#contact"
                  className="inline-flex items-center gap-3 bg-[#C8A84B] text-[#0A3020] text-xs tracking-[0.18em] uppercase font-bold px-7 py-4 hover:bg-[#B8943E] transition-colors"
                >
...
function PracticeCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#040C08]/95 via-[#071E14]/55 to-[#0A3020]/20" />

      <BorderTrace />

      <span className="absolute top-6 left-7 text-[#C8A84B] text-[10px] tracking-[0.25em] uppercase font-medium">
      ...
      <div className="absolute inset-x-0 bottom-0 px-7 pb-7 flex flex-col">
        ...
        <div className="flex items-center gap-2 pt-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-75">
          <span className="text-[#C8A84B] text-[10px] tracking-[0.2em] uppercase font-medium">
            {learnMore}
          </span>
          <svg className="w-3 h-3 text-[#C8A84B]" fill="none" viewBox="0 0 12 12">
  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          <div>
            <p className="text-[#C8A84B] text-xs tracking-[0.3em] uppercase font-medium mb-4">
              {p.eyebrow}
            </p>
  ...
  return (
    ...
    >
      <div className="relative h-44 flex-shrink-0 overflow-hidden" style={{ backgroundColor: "#EDF5F1" }}>
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#0A3020]/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      </div>
      ...
      <div className="flex flex-col flex-1 p-6 gap-3">
        ...
        <h3 className="font-heading text-[#0A3020] text-[0.95rem] font-bold leading-snug tracking-tight group-hover:text-[#0F6844] transition-colors">
          {article.title}
        </h3>
        ...
        <div className="flex items-center justify-between pt-3 border-t border-[#F0F4FB] mt-auto">
          ...
          <div className="flex items-center gap-1.5 text-[#0A3020] group-hover:text-[#C8A84B] transition-colors">
  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          <div>
            <p className="text-[#5AAA82] text-[10px] tracking-[0.3em] uppercase font-semibold mb-3">
              {ins.eyebrow}
            </p>
            <h2 className="font-heading text-[#0A3020] text-[clamp(1.6rem,2.8vw,2.5rem)] font-bold tracking-tight">
              {ins.headline}
            </h2>
          </div>
          <a
            ...
            className="group flex items-center gap-2 text-[#0A3020] hover:text-[#C8A84B] text-xs tracking-[0.15em] uppercase font-medium transition-colors whitespace-nowrap"
          >
    ...
    >
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          ...
          <h2 className="font-heading text-[#0A3020] text-[clamp(1.8rem,3vw,2.8rem)] font-semibold tracking-tight">
            {c.headline}
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-16 lg:gap-24">
          ...
          >
            <p className="text-[#0A3020]/60 text-sm leading-relaxed">{c.subtext}</p>

            <div>
              <p className="text-[#C8A84B] text-[10px] tracking-[0.25em] uppercase font-medium mb-5">
                {c.officeLabel}
              </p>
              <div className="flex flex-col gap-6">
                <div>
                  <p className="text-[#0A3020] text-sm font-semibold mb-1">{c.dubaiLabel}</p>
                  {f.dubaiAddr.map((line, i) => (
                    <p key={i} className="text-[#0A3020]/50 text-xs leading-relaxed">{line}</p>
                  ))}
                </div>
                <div>
                  <p className="text-[#0A3020] text-sm font-semibold mb-1">{c.parisLabel}</p>
            ...
            <div className="flex flex-col gap-2">
              <a
                ...
                className="text-[#0A3020]/60 hover:text-[#C8A84B] text-sm transition-colors"
              >
                {f.email}
              </a>
              <a
          ...
          >
            {submitted ? (
              <div
                ...
                className="border border-[#C8A84B]/40 p-10 flex flex-col gap-4 h-full justify-center"
              >
                <div className="flex items-center gap-3 mb-2">
                  <svg className="w-5 h-5 text-[#C8A84B]" fill="none" viewBox="0 0 20 20">
                    <path d="M4 10l4 4 8-8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  <h3 className="font-heading text-[#0A3020] text-lg font-semibold">{c.successTitle}</h3>
                </div>
                <p className="text-[#0A3020]/60 text-sm leading-relaxed">{c.successText}</p>
              </div>
            ) : (
              <form
              ...
              >
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {c.subjectOptions.map((opt, i) => (
                      <option key={i} value={opt} style={{ color: "#0A3020", background: "#fff" }}>
                        {opt}
                      </option>
                    ))}
                  </select>
                  <svg
                    className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 w-3 h-3 text-[#0A3020]/30"
                    fill="none"
                    viewBox="0 0 12 12"
                  >
                ...
                <button
                  ...
                  className="self-start bg-[#C8A84B] text-[#0A3020] text-xs tracking-[0.2em] uppercase font-semibold px-8 py-4 hover:bg-[#B8943E] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                >
          ...
          <div className="lg:col-span-5 lg:pr-16">
            ...
            <div className="space-y-2">
              <a
                ...
                className="block text-[#C8A84B] text-sm hover:text-[#DCC06A] transition-colors"
              >
                {f.email}
              </a>
...
function EmeraldInner() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#0A3020" }} data-testid="home-v5-page">
      <Header />
      <main>
        <Hero />
        <Insights />
