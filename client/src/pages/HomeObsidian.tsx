...
function Hero() {
  ...
  return (
    <section
      ...
      className="relative min-h-screen bg-[#141C2E] flex items-center overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-8 pt-36 pb-24 w-full">
        ...
        >
          ...
          <motion.div
            ...
            className="h-[2px] bg-[#A8B4C0] mb-8"
          />
...
function Differentiators() {
  ...
  return (
    <section
      ...
      className="bg-[#141C2E] py-28 px-8"
    >
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="flex flex-col">
              {d.cards.map((card, i) => (
                ...
                >
                  <motion.span
                    className="w-0.5 flex-shrink-0 bg-[#A8B4C0] origin-top"
          ...
          <div
            ...
            onMouseLeave={() => setPaused(false)}
          >
            <div className="relative bg-[#080C16] w-full overflow-hidden" style={{ aspectRatio: "4/3" }}>
...
function PracticeAreas() {
  ...
  return (
    <section
      ...
      className="bg-[#0D1220] py-28 px-8"
    >
      <div className="max-w-[1400px] mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
...
function BorderTrace() {
  return (
    <span className="pointer-events-none absolute inset-0 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
      <span className="absolute top-0 left-0 right-0 h-px bg-[#A8B4C0] origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
      <span className="absolute top-0 right-0 bottom-0 w-px bg-[#A8B4C0] origin-top scale-y-0 group-hover:scale-y-100 transition-transform duration-500 delay-100" />
      <span className="absolute bottom-0 left-0 right-0 h-px bg-[#A8B4C0] origin-right scale-x-0 group-hover:scale-x-100 transition-transform duration-500 delay-200" />
      <span className="absolute top-0 left-0 bottom-0 w-px bg-[#A8B4C0] origin-bottom scale-y-0 group-hover:scale-y-100 transition-transform duration-500 delay-300" />
    </span>
  );
}
...
function ArticleCard({
  ...
  return (
    ...
    >
      <div className="relative h-44 flex-shrink-0 overflow-hidden bg-[#F2F3F5]">
        {img ? (
          <img
            src={img}
            alt={article.title}
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input
                    ...
                    className="bg-[#141C2E]/[0.03] border border-[#141C2E]/15 text-[#141C2E] placeholder-[#141C2E]/30 text-sm px-4 py-3.5 outline-none focus:border-[#A8B4C0]/60 transition-colors"
                  />
                  <input
                    type="email"
                    name="email"
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full bg-[#141C2E]/[0.03] border border-[#141C2E]/15 text-sm px-4 py-3.5 outline-none focus:border-[#A8B4C0]/60 transition-colors appearance-none cursor-pointer"
                ...
                <textarea
                  ...
                  className="bg-[#141C2E]/[0.03] border border-[#141C2E]/15 text-[#141C2E] placeholder-[#141C2E]/30 text-sm px-4 py-3.5 outline-none focus:border-[#A8B4C0]/60 transition-colors resize-none"
                />
...
function Footer() {
  ...
  return (
    <footer id="contact" data-testid="footer" className="bg-[#080C16] border-t border-white/8">
