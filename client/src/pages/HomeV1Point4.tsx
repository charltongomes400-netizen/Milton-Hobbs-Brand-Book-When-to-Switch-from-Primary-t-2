    ...
    >
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <p className="text-[#000000] tracking-[0.3em] uppercase font-medium mb-10 text-[16px]">
              {d.eyebrow}
            </p>
          ...
          <div className="lg:col-span-5 lg:pr-16">
            ...
            <div className="space-y-2">
              <a href={`mailto:${f.email}`} data-testid="footer-email"
                className="block text-[#000000] text-sm hover:text-[#000000] transition-colors">
                {f.email}
              </a>
              <a href={`tel:${f.phone}`} data-testid="footer-phone-dubai"
                className="block text-white/40 text-sm hover:text-[#000000] transition-colors">
                Dubai: {f.phone}
              </a>
